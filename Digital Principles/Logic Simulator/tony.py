...
<head>
     ...
     <h1>
        ...
        <img class="tony_" src='https://callmetony.ml/logo/tony.png'>
    </h1>
...
for x in os.listdir():
    ...
    if (x==b)|(x==c)|(x==d)|(x==e)|(x==f)|(x==g):
        ...
        if x.endswith(".pdf"):
            ...
            print("<img src='https://callmetony.ml/logo/logic_.png'/><a href='./",y,"'>",x,"</a><br>",sep='')
        elif x.endswith(".csv"):
            print("<img src='https://img.icons8.com/office/480/000000/csv.png'><a href='./",y,"'>",x,"</a><br>",sep='')
        elif x.endswith(".url"):
            print("<img src='https://img.icons8.com/color/96/FFFFFF/zip.png'/><a href='./",y,"'>",x,"</a><br>",sep='')
            ...
            print("<img src='https://img.icons8.com/color/48/000000/microsoft-powerpoint-2019--v1.png'><a href='./",y,"'>",x,"</a><br>",sep='')
        elif x.endswith(".docx"):
            print("<img src='https://img.icons8.com/color/48/000000/microsoft-word-2019--v2.png'><a href='./",y,"'>",x,"</a><br>",sep='')
        else:
